  ...
  return (
    ...
    <div>
      ...
      <div className="float-right input-group-sm">
        <input className='form-control' type='text' placeholder='Last x days (e.g. 7)' value={days} onChange={(e) => setDays(e.target.value)} />
      </div>
        ...
        <div>
          ...
          <p>
            <button type="button"
              ...
              onClick={() => setToggleVotes(!toggleVotes)}>Show/hide</button>
          </p>
